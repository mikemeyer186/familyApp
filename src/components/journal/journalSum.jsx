...
export default function JournalSum() {
    ...
    return (
        <>
            <Accordion multiple>
                <AccordionTab header={`Einnahmen: ${income.length > 0 ? income[0].sum : 0}`}>
                    <p className="m-0">
                ...
                <AccordionTab header={`Fixkosten: ${fixedCosts.length > 0 ? fixedCosts[0].sum : 0}`}>
                    <p className="m-0">
                ...
                <AccordionTab header={`Variable Kosten: `}>
                    <p className="m-0">
